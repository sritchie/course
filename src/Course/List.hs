...
-- This show instance converts the bitch into a list first. This is
-- probably inefficient, but okay since you don't really do this that
-- much.
...
notReverse Nil = Nil
notReverse xs = t ++ (h :. Nil)
  where (h:.t) = reverse xs
